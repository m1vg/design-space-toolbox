...
//        int i;
        ...
        char * extendedSystem[3] = {"\0"};
        extendedSystem[0] = strdup("x1. = 2*b31*x3 - 2*b12*(x1^2) + a11 + 2*a31 - x1*b11");
        extendedSystem[1] = strdup("x2. = b12*(x1^2) - b23*x2 + a11 + 2*a31 - 2*x2*b22");
        extendedSystem[2] = strdup("x3. = b23*x2 - b31*x3 + a11 + 2*a31 - 2*x3*b33");
...
//        strings[1] = strdup("X2. = b12*(X1^2) - b23*X2 - b22*X2");
//        strings[2] = strdup("X3. = a31 + b23*X2 - b31*X3 - b33*X3");
//        strings[3] = strdup("X4. = k1 + k2 + k3 + k8*X1 - X4*k7 - k6*X4 - k4*X4 - k5*X4");
//        printf("The equations are: %s\n %s\n %s\n %s", *strings, *(strings+1), *(strings+2), *(strings+3));
...
//        printf("The case Prefix is: %s \n", ds->casePrefix);
        ...
        DSCase *aCase = NULL;
        DSUInteger * termSignature, caseNumber = 27; // old case number 27
