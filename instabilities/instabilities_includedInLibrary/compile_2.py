...
os.system("clear")
os.system("rm run_instabilities.o")
...
os.system("gcc -o run_instabilities.o instabilities_develop.c /usr/local/lib/libdesignspace.dylib /usr/local/lib/libglpk.dylib")
os.system("./run_instabilities.o")
